...
use crate::t_xor_plus::{
    block_to_matrix, add_constant_xor, add_constant_plus, s_box_layer, rotate_rows, mix_columns
};
use super::*;
...
fn test_add_constant_plus() {
    ...
    let expected_output = [
        0xF3,0xF1,0xF2,0xF3,0xF4,0xF5,0xF6,0x77,
        0xFB,0xF9,0xFA,0xFB,0xFC,0xFD,0xFE,0x6F,
        0x03,0x02,0x03,0x04,0x05,0x06,0x07,0x68,
        0x0B,0x0A,0x0B,0x0C,0x0D,0x0E,0x0F,0x60,
        0x13,0x12,0x13,0x14,0x15,0x16,0x17,0x58,
        0x1B,0x1A,0x1B,0x1C,0x1D,0x1E,0x1F,0x50,
        0x23,0x22,0x23,0x24,0x25,0x26,0x27,0x48,
        0x2B,0x2A,0x2B,0x2C,0x2D,0x2E,0x2F,0x40,
    ];
    let input_matrix = block_to_matrix(&input);
